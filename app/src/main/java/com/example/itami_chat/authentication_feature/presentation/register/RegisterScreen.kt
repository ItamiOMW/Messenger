...
fun RegisterScreen(
    ...
    confirmPasswordFieldState: PasswordTextFieldState,
        ...
        Column(
            ...
            Column(
                ...
                UnderlinedTextFieldComponent(
                    ...
                    onValueChange = { newValue ->
                        onEvent(RegisterEvent.OnEmailInputChange(newValue))
                    },
                ...
                UnderlinedTextFieldComponent(
                    ...
                    onValueChange = { newValue ->
                        onEvent(RegisterEvent.OnPasswordInputChange(newValue))
                    },
                    ...
                    trailingContent = {
                        IconButton(
                            onClick = { onEvent(RegisterEvent.OnChangePasswordVisibility) }
                        ) {
                            Icon(
                                modifier = Modifier.size(24.dp),
                ...
                UnderlinedTextFieldComponent(
                    modifier = Modifier.fillMaxWidth(),
                    textValue = { confirmPasswordFieldState.text },
                    onValueChange = { newValue ->
                        onEvent(RegisterEvent.OnConfirmPasswordInputChange(newValue))
                    },
                    error = { confirmPasswordFieldState.errorMessage },
                    label = stringResource(R.string.title_confirm_password),
                    enabled = { !state.isRegistering },
                    keyboardType = KeyboardType.Password,
                    visualTransformation = if (confirmPasswordFieldState.isPasswordVisible) VisualTransformation.None else PasswordVisualTransformation(),
                    trailingContent = {
                        IconButton(
                            onClick = { onEvent(RegisterEvent.OnChangeConfirmPasswordVisibility) }
                        ) {
                            Icon(
                                modifier = Modifier.size(24.dp),
                                painter = painterResource(
                                    id = if (confirmPasswordFieldState.isPasswordVisible) R.drawable.ic_visibility_off
                                    else R.drawable.ic_visibility
                                ),
                                contentDescription = stringResource(R.string.desc_change_password_visibility)
                            )
            ...
            Column(
                ...
                ButtonComponent(
                    ...
                    enabled = { !state.isRegistering },
                    onButtonClick = { onEvent(RegisterEvent.OnRegister) }
                )
            }
        }
